=== NHL Hockey Team Stats Lite ===
Contributors: bpmee31
Donate link: http://www.ibet.ws/get_stats.php
Tags: hockey, ncaa hockey, nhl, hockey stats, ncaaf, nhl hockey stats, nhl news, sports stats, stats hockey
Requires at least: 2.2.0
Tested up to: 3.0.1
Stable tag: 0.8.2

NHL Team Stats allows bloggers display an NHL team's standings within their sidebar.

== Description ==

NHL Team Stats plugin can be added to any blog with a dynamic sidebar. Once installed, the blogger can choose their favorite NHL Team. The stats are updated each week of the NHL regular season, so that blog 
visitors can keep track of all the important NHL team standings and stats. Additionally, teams qualifying for post-season play are denoted automatically in each stats table with the the standard NHL *, x,y or z symbols.
...
1. Upload `nhl-team-stats` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. The Plugin will automatically install a new option entry in your wp.options database table.
4. Go to your Design section and select the NHL Stats widget.
...
= Why is there so much "inline" CSS displayed in my NHL Stats table? =
...
Added a function that allows blogger to set a custom color for the stats text output.
